...
private val INPUT = Day12Test::class.java.getResource("/day01_input.txt")?.readText().orEmpty().trim()
...
class Day12Test : FunSpec({
    context("part 1") {
        ...
        xtest("should return expected output for the example") {
            Day12.part1(EXAMPLE) shouldBeEqualTo 0
        }
        ...
        listOf<Pair<String, Long>>(
            ...
            test("part1(\"${input}\") = $expectedOutput") {
                Day12.part1(input) shouldBeEqualTo expectedOutput
            }
        }
    }
