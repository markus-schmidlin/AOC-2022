...
private val INPUT = Day14Test::class.java.getResource("/day01_input.txt")?.readText().orEmpty().trim()
...
class Day14Test : FunSpec({
    context("part 1") {
        ...
        xtest("should return expected output for the example") {
            Day14.part1(EXAMPLE) shouldBeEqualTo 0
        }
        ...
        listOf<Pair<String, Long>>(
            ...
            test("part1(\"${input}\") = $expectedOutput") {
                Day14.part1(input) shouldBeEqualTo expectedOutput
            }
        }
    }
